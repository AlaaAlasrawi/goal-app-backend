package com.goalproject.backend.configuration.security;

import com.goalproject.backend.domain.handlers.CustomAccessDeniedHandler;
import com.goalproject.backend.domain.handlers.CustomAuthenticationEntryPoint;
